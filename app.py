...
st.markdown("Upload your input_data.csv file and get the processed report.")

uploaded_file = st.file_uploader("Upload input_data.csv", type=["csv"])
...
if uploaded_file is not None:
        ...
        for col_idx in range(2, ws.max_column + 1):
            ...
            for row_idx in range(2, ws.max_row + 1):
                ...
                if isinstance(cell.value, (int, float)) and cell.value is not None:
                    ...
                    if cell.value < 0:
                        cell.font = Font(size=8, color="FF0000", bold=(row_idx == ws.max_row))
    ...
    st.info("Please upload your input_data.csv file to begin.")